...
export default class LifeCycle extends Component {
    ...
    constructor(props){
        ...
        //use ref keyword to get direct access to html elements and related events
        // udpated values sent to state
    ...
    //shouldComponentUpdate - is used to check for every state change before calling render
    ...
    render()
    {
        ...
        return(
            <>
                <h2 align="center">Lifecycle Demo</h2>
                {/* <h2>
                {this.state.age}
                <hr/>
                ...
                <form className="form-control col-md-12" action="/api/loginuser" 
                    ...
                    <b>Session</b>
                    <input type="text" className="form-control" placeholder={"Default User Session"} 
